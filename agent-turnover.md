...
- **Symptom**: App crashed on iPhone 14
- **Cause**: Missing NSCameraUsageDescription and related keys
- **Fix**: Added INFOPLIST_KEY_* entries to project.pbxproj
- **Commit**: 9528e82 on ios-dev-2026-01

### 2026-01-11: Device Install Hang
- **Symptom**: xcrun devicectl hangs at "Acquired usage assertion"
- **Workaround**: Use Xcode GUI (Product → Run or Cmd+R)

### 2026-01-11: ImagePicker Simulator Crash
...
| NavigationView in iOS 16+ | Deprecated |
...
- Agent Memory: /Users/celtic57/projects/TurnOverX/agent-turnover.md
